...
public class KernelRidgeModelSecurity {
	private Integer kernelRekernelessionAuthId;
	...
	public KernelRidgeModelSecurity() {

	}

	public KernelRidgeModelSecurity(Integer kernelRekernelessionAuthId, String authMethod, boolean oauth2Support,
			String jwtSubject, String issuer, String audience, long issuedAt, String federalIdentitySupport,
			String creationDate, String modifiedDate, String entityState) {
		super();
		this.kernelRekernelessionAuthId = kernelRekernelessionAuthId;
	...
	public Integer getKernelRekernelessionAuthId() {
		return kernelRekernelessionAuthId;
	}

	public void setKernelRekernelessionAuthId(Integer kernelRekernelessionAuthId) {
		this.kernelRekernelessionAuthId = kernelRekernelessionAuthId;
	}
